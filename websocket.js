            ...
            ws.on('message', function (message) {
                try {
                    ...
                    if (result.route == "GetData") {
                        GetData(result.data).then(function (result) {
                    ...
                    if (result.route == "SetData") {
                        if (result.update) {
                            ...
                            SetData(result.data).then(function (res) {
...
function SetData(msg) {
    return new Promise(function (resolve, reject) {
        var result = storage_1.Storage.SetData(msg.appname, msg.data);
        var obj = {
            route: 'ExistingData',
            data: {
                appname: msg.appname,
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    console.log(msg);
                    storage_1.Storage.GetData(msg.appname).then(function (result) {
                        var obj = {
                            route: 'ExistingData',
                            data: {
                                appname: msg.appname,
